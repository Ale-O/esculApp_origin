<?php ob_start(); ?>
    ...
    <p>
    <a href="index.php?action=createSupport" class="btn btn-primary">Nouveau support</a>
    </p>
    ...
    if (isset($search)){
        ...
        <p>
        <br>
        <a href="index.php?action=exportAllSupport" class="btn btn-primary">Export</a>
        </p>
    ...
    require ("view/fronted/form/loadSearchSupportForm.php");
       ...
       <thead>
          <tr>
                ...
                <th>Voir</th>
                <th>Numéro</th>
                <th>dernier occupant</th>
                <th>absence-départ liée</th>
                <th>début vacance</th>
                <th>fin vacance</th>
